...
const fillBdays = () => {
  if (sessionStorage.getItem("pwdCorrect") == "yes" && sessionStorage.getItem("pwdChecked") == "yes") {
    let bdayArray = [["Jan", 8, "Trisha"], ["Jan", 8, "Vaishnavi"], ["Jan", 16, "Didi"], ["Jan", 25, "Rajal"], ["Jan", 27, "Snehal"], ["Feb", 4, "Mom & Dad Anniversary"], ["Feb", 22, "Dadi"], ["Mar", 10, "Aishu (SIMS)"], ["Apr", 11, "Abhiram"], ["Apr", 19, "Brino"], ["Apr", 22, "Rachana"], ["Apr", 23, "Kumar"], ["May", 11, "Shravya"], ["May", 16, "Mum"], ["May", 18, "Sauru"], ["May", 24, "Neha (SIMS)"], ["Jun", 12, "Raksha (GF)"], ["Jun", 16, "Darshan"], ["Jun", 20, "Vaishnavi (Goa)"], ["Jun", 23, "Deepz"], ["Jul", 1, "Ziya"], ["Jul", 14, "Anju"], ["Jul", 31, "Wizz"], ["Aug", 1, "Pratham"], ["Sep", 12, "Akash V"], ["Sep", 19, "Aaron"], ["Oct", 3, "Nivedh"], ["Nov", 3, "Otaku"], ["Nov", 5, "Nandu"], ["Nov", 14, "Anu Behen"], ["Nov", 20, "Sanjay (SIMS)"], ["Nov", 27, "Vinti"], ["Dec", 8, "Janani Miss"], ["Dec", 21, "Rohit (SIMS)"]];
